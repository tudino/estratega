...
export const STRATEGY_SCHEMAS = {
  ArbitrajeMEP: {
    ticker_ars: { type: "text", required: true, label: "Ticker en Pesos", default: "" },
    ticker_usd: { type: "text", required: true, label: "Ticker en Dolares", default: "" },
    ...
    compra_en_pesos: { type: "boolean", required: false, label: "Compra en Pesos", default: true },
    venta_en_pesos: { type: "boolean", required: false, label: "Venta en Pesos", default: true },
    compra_en_dolares: { type: "boolean", required: false, label: "Compra en Dolares", default: true },
    venta_en_dolares: { type: "boolean", required: false, label: "Venta en Dolares", default: true },
    profundidad_minima: { type: "number", required: false, label: "Profundidad Mínima (order book)", default: 2 },
    intervalo: { type: "number", required: false, label: "Intervalo (segundos)", default: "20" },
    mejorar_precio: { type: "boolean", required: false, label: "Mejorar Precio (posicionarse primero en el book)", default: false },
